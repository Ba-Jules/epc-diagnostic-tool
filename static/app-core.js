...
// Modale d'edition generique (correctifs cibles :8820, cf. consignes_claude.txt,
// point 3) - remplace window.prompt() partout : un formulaire integre
// (champ(s), Enregistrer, Annuler) plutot qu'une boite de dialogue navigateur
